...
@CrossOrigin(origins={"http://0.0.0.0:3000","https://musicappnext.vercel.app/uploadMySong"})
...
public class SongController {
    ...
    public ResponseEntity<Song> addAsFavourite(@RequestParam("id") String id, @RequestParam("favourite") boolean favourite){
        Optional<Song> songOptional = songRepository.findById(id);
        if ( songOptional.isPresent() ) {
            Song song = songOptional.get();
            song.setFavourite(favourite);
